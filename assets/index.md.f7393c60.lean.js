...
`),n("span",{class:"token punctuation"},"{"),e(`
    ...
    `),n("span",{class:"token punctuation"},"}"),e(`
`),n("span",{class:"token punctuation"},"}"),e(`
`)])])])],-1),h=s("",6);function m(g,_,f,b,A,w){const t=l("codeblock");return p(),c("div",null,[u,i(t,{id:"minimal"},{at:a(()=>[d]),an:a(()=>[k]),_:1}),h])}var P=o(r,[["render",m]]);export{x as __pageData,P as default};
